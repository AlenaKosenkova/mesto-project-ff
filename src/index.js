...
const interBlackFont = new URL('./vendor/fonts/Inter-Black.woff2', import.meta.url);
const interMediumFont = new URL('./vendor/fonts/Inter-Medium.woff2', import.meta.url);
const interRegularFont = new URL('./vendor/fonts/Inter-Regular.woff2', import.meta.url);
